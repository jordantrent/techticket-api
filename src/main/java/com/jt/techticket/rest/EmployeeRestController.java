...
//TODO again here - all the processing should be done in the service layer
...
//        TODO why are you setting the id to 0 here? The id should be generated by the database
        employee.setId(0);
...
//        TODO by creating custom exception handlers you can just throw an error rather than using ResponseEntitys e.g. https://stackoverflow.com/a/25422563
        if (tickets.isEmpty()) {
...
//        TODO same here as updateCustomer this would be clearer not as method chaining
        return employeeRepository.findById(id)
